...
//@hack - Solspace Addition
eval('class Excel_reader extends Spreadsheet_Excel_Reader { }');
...
//            $r = &$this->file->nextRecord();
    ...
    {
        //echo "add cell $row-$col $string ($raw)\n";
...
/* ******************************************
Previously in file oleread.inc
******************************************* */
...
class OLERead {
    var $data		= '';
    var $fetchfile	= TRUE;	//@hack - Solspace Addition
    ...
    function read($sFileName){
    	...
    	//@hack - Begin Solspace Addition
    	/* In most cases the Importer module loads data itself from sources and passes that data over to this library for parsing. */

    	if ( $this->fetchfile === TRUE )
    	{
